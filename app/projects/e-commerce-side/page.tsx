...
import { FiArrowLeft, FiArrowRight, FiGithub, FiExternalLink, FiShoppingCart, FiCreditCard, FiShield, FiTag } from 'react-icons/fi';

const images = Array.from({ length: 9 }, (_, i) => `/resimler/e-commerce-side/eco${i + 1}.png`);
  ...
  return (
    <div className="min-h-screen bg-space-950 text-white pt-20 pb-10 px-4 md:px-8 relative overflow-hidden">
      <div className="absolute inset-0 overflow-hidden -z-10 bg-[#020617]">
        <div className="absolute bottom-0 right-0 w-full h-full bg-blue-600/5 blur-[120px] rounded-full" />
      </div>
      ...
      <div className="container mx-auto max-w-7xl pt-10 pb-10">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-bold text-white tracking-tight uppercase">
            E-COMMERCE <span className="text-blue-500">SIDE</span>
          </h1>
          <p className="text-gray-400 text-lg md:text-xl leading-relaxed font-light text-justify max-w-3xl mx-auto">
            Modern ve kullanıcı dostu bir e-ticaret platformu olarak tasarlanan E-Commerce Side, ürün yönetimi, sepet işlemleri,
            güvenli ödeme akışları ve kapsamlı bir admin paneli sunar. React ve Tailwind CSS kullanılarak geliştirilen
            platform, hem alıcılar hem de satıcılar için akıcı bir deneyim hedefler.
          </p>
        </motion.div>
            ...
            >
              <div className="relative h-[400px] md:h-[650px] w-full bg-white/5 border border-white/10 rounded-[2.5rem] overflow-hidden shadow-2xl backdrop-blur-sm shimmer-dark">
                <Image
                  ...
                  alt={`E-Commerce View ${currentImageIndex + 1}`}
                  fill
          ...
          <div className="lg:col-span-5 space-y-10">
            <div className="space-y-8">
              <div className="grid grid-cols-2 gap-4">
                {[
                  { icon: <FiShoppingCart />, title: 'Smart Cart' },
                  { icon: <FiCreditCard />, title: 'Payments' },
                  { icon: <FiShield />, title: 'Secure' },
                  { icon: <FiTag />, title: 'Campaigns' }
                ].map((f, i) => (
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {['React.js', 'JavaScript', 'Tailwind CSS', 'Framer Motion', 'Context API'].map((t) => (
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white/5 p-8 rounded-[2rem] border border-white/10 space-y-4">
            <h4 className="text-xl font-bold text-white uppercase tracking-tight">🛍️ Ürün Yönetimi</h4>
            <p className="text-gray-400 text-sm leading-relaxed">Kategori bazlı filtreleme, detaylı ürün sayfaları ve varyant yönetimi ile profesyonel bir alışveriş akışı.</p>
          </div>
          <div className="bg-white/5 p-8 rounded-[2rem] border border-white/10 space-y-4">
            <h4 className="text-xl font-bold text-white uppercase tracking-tight">🔒 Güvenli Ödeme</h4>
            <p className="text-gray-400 text-sm leading-relaxed">Kullanıcı verilerinin güvenliğini her zaman ön planda tutan, modern ödeme sistemleri ile uyumlu sandbox entegrasyonu.</p>
          </div>
          <div className="bg-white/5 p-8 rounded-[2rem] border border-white/10 space-y-4">
            <h4 className="text-xl font-bold text-white uppercase tracking-tight">🛠️ Admin Paneli</h4>
            <p className="text-gray-400 text-sm leading-relaxed">Stok durumu, sipariş takibi ve kullanıcı yönetimi gibi kritik işlemlerin kolayca yapılabildiği merkezi yönetim birimi.</p>
          </div>
        </div>
      </div>
    </div>
