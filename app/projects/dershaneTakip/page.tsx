...
import { FiArrowLeft, FiArrowRight, FiGithub, FiExternalLink, FiUser, FiBarChart2, FiAward, FiSettings } from 'react-icons/fi';

const images = Array.from({ length: 15 }, (_, i) => `/resimler/dershaneTakip/${i + 1}.png`);

export default function DershaneTakipDetail() {
                        ...
                        >
                            <div className="relative h-[400px] md:h-[550px] w-full bg-white/5 border border-white/10 rounded-[2.5rem] overflow-hidden shadow-2xl backdrop-blur-sm shimmer-dark">
                                <Image
                                    ...
                                    alt={`Dershane Takip View ${currentImageIndex + 1}`}
                                    fill
