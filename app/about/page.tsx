                        ...
                        <div className="flex flex-wrap gap-2 pt-2">
                          {(item as any).images.slice(0, 4).map((img: string, idx: number) => (
                            <motion.div
                              ...
                              className="relative w-20 h-14 md:w-24 md:h-16 rounded-xl overflow-hidden cursor-zoom-in border border-white/10 hover:border-blue-400/50 transition-colors shadow-lg group/img bg-white/5"
                            >
      ...
      <AnimatePresence>
        {isGalleryOpen && (
          ...
          >
            ...
            >
              <div className="absolute inset-0 flex items-center justify-between px-4 md:-mx-16 pointer-events-none">
                {activeGalleryImages.length > 1 && (
                  <>
                    <button
                      onClick={prevGalleryImage}
                      className="pointer-events-auto text-white/30 hover:text-white transition-all bg-white/5 hover:bg-white/10 p-4 rounded-full"
                    >
              ...
              <div className="absolute bottom-4 left-1/2 -translate-x-1/2 text-white/50 font-black tracking-[0.4em] text-xs uppercase bg-white/5 px-6 py-2 rounded-full backdrop-blur-md border border-white/5">
